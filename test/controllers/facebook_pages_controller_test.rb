...
class FacebookPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facebook_page" do
    assert_difference('FacebookPage.count') do
      post facebook_pages_url, params: { facebook_page: { access_token: @facebook_page.access_token, name: @facebook_page.name, organization_id: @facebook_page.organization_id } }
    end
  ...
  test "should update facebook_page" do
    patch facebook_page_url(@facebook_page), params: { facebook_page: { access_token: @facebook_page.access_token, name: @facebook_page.name, organization_id: @facebook_page.organization_id } }
